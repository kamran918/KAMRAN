# Decompile by Kamran (Tools By Kamran-Ayoub)
# Time Succes decompile : 2022-06-29 18:44:58.596548
Facebook:https://www.facebook.com/HACKER302GANG
WhatsApp: +923025968225
...
\033[1;92m╔══o00════════00o═════════════════════════╗
\033[1;31;1m█ \033[1;92m [•] \033[1;31;1mAuthor    :  \033[1;92m  Kamran404           \033[1;31;1m █
\033[1;31;1m█ \033[1;92m [•] \033[1;31;1mWhatsapp  :  \033[1;92m Suliman          \033[1;31;1m █
    ...
    if len(ok) != 0 or len(cp) != 0:
        ...
        if cek_cp =="":
            ...
            for memek in cp:
                ...
                titid  = kontol.split(' • ')
                print(f'{N}══════════════════════════════════════════\n {H}LOGIN PROCESS')
                jalan(f' {N}[{M}?{N}] Account : {K}{kontol.replace("[KAMI-CP] ", "")}{N}')
                try:
